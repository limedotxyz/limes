...
const SCANNER_WS = process.env.NEXT_PUBLIC_SCANNER_WS || "ws://localhost:4211";
      ...
      <main className="mx-auto max-w-7xl px-4 py-5 space-y-4">
        ...
        <footer className="border-t border-[var(--color-border)] pt-4 space-y-2">
          <div className="flex justify-center items-center gap-3">
            <a href="https://github.com/limes-network/limes" target="_blank" rel="noopener noreferrer" className="text-[var(--color-foreground)]/30 hover:text-[var(--color-lime)] transition-colors" title="GitHub">
